...
{
	// Lab 3.02. Create a command queueDO
...
void cg::renderer::dx12_renderer::create_render_target_views()
{
	...
	//   3.04. Create render target views
...
{
	// 3.06. Create command allocators and a command list
...
{
	// 3.05. Create a descriptor table and a root signature
...
{
	//  3.04. Create a constant buffer view
...
{
	// T Lab 3.04. Implement `create_heap`, `get_cpu_descriptor_handle`, `get_gpu_descriptor_handle`, and `get` methods of `cg::renderer::descriptor_heap`
...
{
	// TLab 3.04. Implement `create_heap`, `get_cpu_descriptor_handle`, `get_gpu_descriptor_handle`, and `get` methods of `cg::renderer::descriptor_heap`
...
{
	//  3.04. Implement `create_heap`, `get_cpu_descriptor_handle`, `get_gpu_descriptor_handle`, and `get` methods of `cg::renderer::descriptor_heap`
	return heap.Get();
}
